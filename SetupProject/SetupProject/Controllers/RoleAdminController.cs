    ...
    public class RoleAdminController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            foreach (IdentityRole role in _roleManager.Roles)
            {
                ...
                rem.Members = RoleMembers; //list of users in this role
                rem.NonMembers = RoleNonMembers; //list of users NOT in this role
                roles.Add(rem);
            }
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            rem.Members = RoleMembers; //list of users in the role
            rem.NonMembers = RoleNonMembers; //list of users NOT in the role
