    ...
    public class Startup
{
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddControllersWithViews();
            ...
            String connectionString = "Server=tcp:spr22teamfinalproject.database.windows.net,1433;Initial Catalog=spr22teamfinalproject;Persist Security Info=false;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
